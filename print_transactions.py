...
def main():
    """
    Runs the program and prints out a list of transactions that have been scraped.
    """
    log.info("Starting FNB scraper.")
    username = os.environ["FNB_USERNAME"] if args.username is None else args.username
    password = os.environ["FNB_PASSWORD"] if args.password is None else args.password
